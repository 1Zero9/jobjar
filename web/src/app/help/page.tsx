...
const GUIDE_SECTIONS = [
  ...
  },
  {
    id: "teens",
    title: "Teens",
    subtitle: "For 12 to 18 users who work from the task board with simpler wording.",
    points: [
      "Open Task board from home.",
  ...
  return (
    <div className={`capture-shell page-help ${audienceThemeClass} min-h-screen px-4 py-5`}>
      <main className="mx-auto flex w-full max-w-[34rem] flex-col gap-6">
        <AppPageHeader
          title="Help"
          subtitle="Quick guidance for this account, plus simple guides for the rest of the household."
          iconClassName="help"
          icon={
          ...
          actions={
            <>
              ...
              {canSeeExtended ? <Link href="/projects" className="action-btn subtle quiet">Projects</Link> : null}
        ...
        <section className="stats-panel help-hero-panel">
          ...
          <h2 className="recorded-title">{recommendedGuide.title} guide</h2>
          <p className="page-hero-subtitle">{recommendedGuide.subtitle}</p>
            ...
            <div className="rounded-2xl border border-border bg-surface p-4">
              ...
              <p className="mt-2 text-sm text-muted">
                {canAct
                  ...
                  : "view the household without changing tasks or projects"}
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-surface p-4">
